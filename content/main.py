...
_HERO = """<div class="hero">
  <div class="hero-content">
    <div class="hero-badge">경기 전지역 방문 관리 · 연중무휴 24시간</div>
    <h1 class="hero-title">경기도 출장마사지<br><span class="hero-accent">경기 전지역 홈타이</span><br>예약 안내</h1>
    <p class="hero-lead">수원, 성남, 용인, 고양, 부천, 안산, 안양, 화성, 평택, 남양주, 김포, 의정부 등 경기도 주요 지역별 방문 가능 지역과 예약 전 확인사항을 안내합니다.</p>
    <div class="hero-cta">
